...
```
colab/
├── banking77_finetune.ipynb   # Main notebook (all sections below)
│
...
**Execution**:
1. Open `banking77_finetune.ipynb` in Google Colab
2. Runtime → Change runtime type → T4 GPU
3. Click the Google Drive authorisation popup (one unavoidable manual click)
4. Runtime → Run all

Full instructions and troubleshooting: [`run_instruct.txt`](run_instruct.txt)
